...
def test_yaml_config():
    ...
    assert config["endpoints"][1] == {"method": "POST", "path": "posts", "expected_status": 201, "expected_keys": EXPECTED_KEYS}
    assert config["endpoints"][2] == {"method": "PUT", "path": "posts/1", "expected_status": 200, "expected_keys": EXPECTED_KEYS}
